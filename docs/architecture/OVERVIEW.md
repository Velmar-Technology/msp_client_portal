# MSP Help Desk — Client Portal (Architecture Overview)

> Deep-dive architecture, business logic, and operational documentation.
> For the product-facing summary and quick start, see the [repo README](../../README.md).
