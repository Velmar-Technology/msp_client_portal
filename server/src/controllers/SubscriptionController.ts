...
export class SubscriptionController {
  async getAll(req: Request, res: Response): Promise<void> {
    const subscriptions = await subscriptionService.getClientSubscriptions(req.user!.userId);
  ...
  async create(req: Request, res: Response): Promise<void> {
    ...
    const subscription = await subscriptionService.createSubscription(data, req.user!.userId);
