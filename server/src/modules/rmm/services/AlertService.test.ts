...
vi.mock('@modules/rmm/repositories/RmmAlertRepository', () => {
  return {
    rmmAlertRepository: {
...
vi.mock('@modules/tickets/services/TicketCreationService', () => {
  return {
...
import { RmmAlertInput, TicketCategory, TicketPriority, TicketStatus } from '@shared/types';
