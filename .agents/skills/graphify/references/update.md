...
Clean up after: `Remove-Item graphify-out\.graphify_old.json -Force -ErrorAction SilentlyContinue`
...
```powershell
& (Get-Content graphify-out\.graphify_python) -m graphify cluster-only .
```
