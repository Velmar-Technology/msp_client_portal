            ...
            {isIncreaseCount && !isMockOrI ? (
              <div className="mt-2 border-t border-zinc-200/50 dark:border-zinc-800/50 pt-3">
                ...
                <div
                  ...
                  className="my-1.5 min-h-25 flex items-center justify-center bg-zinc-50/20 rounded-md p-3 border border-zinc-200 dark:border-zinc-800 border-dashed"
                >
                ...
                {paymentMessage && (
                  <p className="text-xs text-zinc-900 dark:text-zinc-50 font-semibold mt-1.5">{paymentMessage}</p>
                )}
              </div>
            ) : (
              <button
