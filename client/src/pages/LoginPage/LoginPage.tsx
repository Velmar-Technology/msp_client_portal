...
export function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-zinc-50 dark:bg-zinc-950 p-6 md:p-10 transition-colors">
        ...
        <Card className="overflow-hidden p-0 border-zinc-200 dark:border-zinc-800 shadow-2xl rounded-2xl">
          <CardContent className="grid p-0 md:grid-cols-2">
            ...
            <div className="p-6 md:p-10 flex flex-col justify-center bg-white dark:bg-zinc-900">
              ...
              {error && (
                <Alert variant="destructive" className="mb-5 py-2.5 px-3">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900 h-10 rounded-lg text-sm font-bold hover:opacity-90 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 cursor-pointer shadow-md"
                >
                  {loading ? (
