    ...
    <div className="min-h-screen flex items-center justify-center bg-zinc-50 dark:bg-zinc-950 px-4 transition-colors py-12">
      <div className="w-full max-w-[400px] animate-fade-in">
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 md:p-8 shadow-xl relative overflow-hidden">
          <h2
            className="text-xl font-extrabold text-zinc-900 dark:text-zinc-100 mb-1 tracking-tight"
            style={{ fontFamily: "var(--font-heading)" }}
          >
            {t("register.createAccountHeader")}
          </h2>
          <p className="text-sm text-zinc-500 dark:text-zinc-400 mb-6 font-medium">{t("register.registerToPortal")}</p>
          ...
          {showOtpForm && (
            <form onSubmit={handleVerifyOtp} className="space-y-4 animate-fade-in" autoComplete="off">
              <div>
                <label
                  htmlFor="otp"
                  ...
                  render={({ field, fieldState }) => (
                    <Field data-invalid={fieldState.invalid}>
                      ...
                      <Select value={field.value} onValueChange={field.onChange}>
                        <SelectTrigger
                          id="reg-clientType"
                          className="w-full h-10 data-[size=default]:h-10 px-3 py-2 border border-zinc-200 dark:border-zinc-800 rounded-lg text-sm bg-zinc-50 dark:bg-zinc-950 focus:outline-none focus:border-zinc-400 dark:focus:border-zinc-600 transition-all text-zinc-900 dark:text-zinc-100 shadow-sm cursor-pointer"
                        >
                ...
                <Controller
                  ...
                  render={({ field, fieldState }) => (
                    <Field data-invalid={fieldState.invalid}>
                      <FieldLabel
                        htmlFor="reg-phone"
                        className="block text-[10px] font-bold text-zinc-700 dark:text-zinc-300 uppercase tracking-wider mb-1.5 flex items-center justify-between"
                      >
                        <span>{t("register.phoneNumber", "Phone Number")}</span>
                      </FieldLabel>
                      <Input
                        {...field}
                        id="reg-phone"
