...
export const RESOURCE_CATALOG: ResourceItem[] = [
  ...
  },
  {
    ...
    category: "software",
    plans: ["PL-001", "PL-002", "PL-003"],
    url: "https://github.com/nextcloud-releases/desktop/releases/download/v34.0.0/Nextcloud-34.0.0.pkg",
    fileName: "Nextcloud-34.0.0.pkg",
    fileType: "PKG",
    fileSize: "152.0 MB",
    updatedAt: "2026-08-04T00:00:00.000Z",
    os: ["macos"],
  },
  {
    ...
    category: "software",
    plans: ["PL-001", "PL-002", "PL-003"],
    url: "https://github.com/nextcloud-releases/desktop/releases/download/v34.0.0/Nextcloud-34.0.0-x86_64.AppImage",
    fileName: "Nextcloud-34.0.0-x86_64.AppImage",
    fileType: "AppImage",
    fileSize: "160.0 MB",
    updatedAt: "2026-08-04T00:00:00.000Z",
    os: ["linux"],
  },
  {
    ...
    category: "guide",
    plans: ["PL-001", "PL-002", "PL-003"],
    url: "/resources/quickstart-activation-and-first-backup.pdf",
    fileName: "quickstart-activation-and-first-backup.pdf",
    fileType: "PDF",
    fileSize: "1.8 MB",
    updatedAt: "2026-08-04T00:00:00.000Z",
  },
