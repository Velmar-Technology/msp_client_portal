 ...
 * Uses TanStack Query hooks from colocated billing API for server state with automatic cache invalidation.
 *
...
export function useBilling() {
  ...
  const showDetailsModal =
    (openModalParam === 'invoice-details' || (!openModalParam && !!invoiceIdParam)) &&
