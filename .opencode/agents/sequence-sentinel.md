...
2. Inspect the `remediations` array in the audit result:
   ...
   - **BL-801 (Technician Bounties & OpEx):** Calculates priority-weighted commissions ($8 base × multiplier + $4 SLA), records earnings, and auto-posts Pre-Split OpEx into `expenses`.
